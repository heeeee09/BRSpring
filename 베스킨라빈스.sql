...
CREATE TABLE STORE_TBL (
    ...
    STORE_TELL VARCHAR2(13),
    STORE_LAT VARCHAR2(30),
    STORE_LNG VARCHAR2(30)
);

drop table STORE_TBL;

INSERT INTO STORE_TBL VALUES(1, '베스킨라빈스 서울역 1호점', '서울특별시 중구 봉래동2가 122-11', '02-313-7131', '37.5543', '126.9712');
INSERT INTO STORE_TBL VALUES(2, '배스킨라빈스명동일호', '서울특별시 중구 충무로1가 25-2번지 1층', '02-2276-4679', '37.561126', '126.983080'); 
