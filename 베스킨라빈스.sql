...
CREATE TABLE SYSTEM_TBL (
    SYSTEM_ID VARCHAR2(20) PRIMARY KEY,
    SYSTEM_PW VARCHAR2(20) NOT NULL,
...
insert into SYSTEM_TBL values('brsystem', 'syspass', '관리자');
...
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '31요거트');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '그린티');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '레인보우 샤베트');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '민트 초콜릿칩');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '바람과 함께 사라지다');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '베리베리 스트로베리');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '슈팅스타');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '아몬드 봉봉');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '엄마는 외계인');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '이상한 나라의 솜사탕');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '초코나무 숲');
INSERT INTO MENU_ICECREAM_TBL VALUES('아이스크림', '쿠키 앤 크림');
