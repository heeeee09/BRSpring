	    ...
	    <div id="container">
	        ...
	        <section>
	            <div id="menuBox">
	                ...
	                <div id="menuPage">
	                    <div id="menuImg">
	                        <img src="../../resources/image/product/icecream/베리베리_스트로베리.png" alt="베리베리 스트로베리">
	                    </div>
	                    <div>
	                        <div>
                                <form action="" method="post">
		                            <div id="menuTop">
	                               	 	<p id="menuName">베리베리 스트로베리</p>
		                                <input type="hidden" name="31yogurt">
	                               		<button id="order" onclick="orderLink()">주문하기</button>
		                            </div>
                                </form>
	                            <p id="detail">새콤상큼 딸기 과육이 듬뿍!</p>
                        	</div>
	                        <div>
	                            <p id="con">CONE & CUP</p>
	                            <div class="leftTop">
