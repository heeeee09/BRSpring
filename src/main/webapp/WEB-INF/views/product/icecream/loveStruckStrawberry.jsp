	    ...
	    <div id="container">
	        ...
	        <section>
	            <div id="menuBox">
	                ...
	                <div id="menuPage">
	                    <div id="menuImg">
	                        <img src="../../resources/image/product/icecream/사랑에_빠진_딸기.png" alt="사랑에 빠진 딸기">
	                    </div>
	                    <div>
	                        <div>
                                <form action="" method="post">
		                            <div id="menuTop">
	                               	 	<p id="menuName">사랑에 빠진 딸기</p>
		                                <input type="hidden" name="loveStruckStrawberry">
	                               		<button id="order" onclick="orderLink()">주문하기</button>
		                            </div>
                                </form>
	                            <p id="detail">크런치 초콜릿, 치즈 케이크, 스트로베리가 듬뿍 들어있는 아이스크림</p>
                        	</div>
	                        <div>
	                            <p id="con">CONE & CUP</p>
	                            <div class="leftTop">
