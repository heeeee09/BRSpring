	    ...
	    <div id="container">
	        ...
	        <section>
	            <div id="menuBox">
	                ...
	                <div id="menuPage">
	                    <div id="menuImg">
	                        <img src="../../resources/image/product/icecream/프릳츠_커피_아이스크림.png" alt="프릳츠 커피 아이스크림">
	                    </div>
	                    <div>
	                        <div>
                                <form action="" method="post">
		                            <div id="menuTop">
	                               	 	<p id="menuName">프릳츠 커피 아이스크림</p>
		                                <input type="hidden" name="fritzCoffeeIceCream">
	                               		<button id="order" onclick="orderLink()">주문하기</button>
		                            </div>
                                </form>
	                            <p id="detail">프릳츠 올드독 원두로 만든 커피 아이스크림에 커피 초콜릿 칩과 초콜릿 리본, 흑당 피칸이 어우러진 맛</p>
                        	</div>
	                        <div>
	                            <p id="con">CONE & CUP</p>
	                            <div class="leftTop">
